  ...
  return (
    <main className="catering-home-shell">
      <nav className="catering-home-nav" aria-label="Ana navigasyon">
        <Link className="catering-brand" href="/">
          <span>BY</span>
          <div>
        ...
        <div>
          <Link href="/giris">Şirket girişi</Link>
          <Link className="catering-nav-button" href="/catering">
            Catering paneli
          </Link>
        </div>
      </nav>
      ...
      <section className="catering-hero-section">
        <div className="catering-hero-copy">
          ...
          <p>
            Şirket üyeliği üzerinden çalışan sade bir catering akışı: şirket kişi sayısını girer,
            catering porsiyonu planlar, yemek sonrası tabak toplama onayı düşer.
          </p>
          <div className="catering-hero-actions">
            <Link className="catering-primary-button" href="/catering">
              Paneli aç
              <ArrowRight size={18} />
            </Link>
            <Link className="catering-secondary-button" href="/giris">
